...
import {formatEnrollmentText} from "./welcome";
...
export async function sendWelcomeBack(first_name, plan_name, mailing_date, renewal_plan_price, renewal_date, email) {
  let enrollmentText = formatEnrollmentText(plan_name, renewal_plan_price, renewal_date);
  let mailingDate = (mailing_date - 1) + ordinalSuffixes[(mailing_date - 1)];
  await send(email, subject(),
    html(first_name, mailingDate, enrollmentText),
    text(mailingDate, plan_name, enrollmentText));
}

function subject() {
  return `Welcome back to Book of the Month!`;
}

function text(mailingDate, enrollmentText) {
  return `
Welcome back! 

Thank you for continuing your Book of the Month subscription. Since 1926, Book of the Month has provided discerning readers like you with the very best books of the moment, delivered directly to your door. Below you will find all of the details about your membership. Thank you for choosing Book of the Month.

What Happens Next:
  1. Visit MY BOTM to select your Book of the Month by the ${mailingDate}.
...
export function html(first_name, mailingDate, plan_name, enrollmentText) {
  return `
<!-- welcome message -->
  <tr>
    <td>
            ...
            <table cellpadding="2" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td style="font-size:14px; font-family: Arial, Helvetica, sans-serif, 'Roboto'; line-height:150%; text-align: left; font-weight: 300; max-width: 494px; color: #333333;" >
                   Visit <a href="https://www.bookofthemonth.com/my-botm">MY BOTM</a> to select your Book of the Month by the ${mailingDate}.
                </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
      ...
      <table cellpadding="20" cellspacing="0" border="0" width="100%" style="background-color:#ffffff; border: 1px solid #deddd5;">
        <tr>
          <td>
            <table cellpadding="2" cellspacing="0" width="100%">
              <tr>
                <td style="font-size:16px; font-family: Arial, Helvetica, sans-serif, 'Roboto'; line-height:130%; text-align: center; font-weight: 400; color:#182747; ">
                   <span style="display: inline-block; padding-bottom: 3px; margin-bottom: 15px; border-bottom: 2px solid #2cc4ee; color:#182747; ">ABOUT YOUR MEMBERSHIP</span>
                </td>
              </tr>
              <tr>
                <td valign="top" align="center" style="vertical-align:top; font-size:14px; font-family: Arial, Helvetica, sans-serif, 'Roboto'; line-height:150%; color:#262c2d ; text-align: center; font-weight:200;">
                  ${plan_name}
                </td>
              </tr>
