...
You have redeemed a  ${data.planName} membership to Book of the Month. Your membership will end on ${data.renewalDate} unless you visit the Payments and Plans section of website and choose a renewal plan. For a complete list of the terms of your membership please visit https://www.bookofthemonth.com/membership-terms.html. If you would like to cancel your membership at any time, please call 1-888-784-2670.

We hope you enjoy for first month!  Please let us know if you have any questions by emailing member.services@bookfothemonth.com
          ...
          <td>
            ...
            <!-- new selections-->
              <tr>
                ...
                <td style="font-size:14px; font-family: Arial, Helvetica, sans-serif, 'Roboto'; line-height:150%; text-align: left; font-weight: 300; max-width: 494px;" >
              ...
              <tr>
                ...
                <td style="font-size:14px; font-family: Arial, Helvetica, sans-serif, 'Roboto'; line-height:150%; text-align: left; font-weight: 300; max-width: 494px;" >
                   On the 7th of the month, your box will ship. When you're done reading your books, be sure to head over to the Magazine or the Discussions to see what other members are saying.
                </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              ...
              <tr>
               ...
               <tr>
                  <td style="vertical-align:top; font-family: Arial, Helvetica, sans-serif, 'Roboto'; color:#595962; font-size: 14px; line-height: 150%; font-weight: 400; ">
                    You have redeemed a ${data.planName} membership to Book of the Month. <span style="font-weight: 700">Your membership will end on ${data.renewalDate} unless you visit the Payments and Plans section of website and choose a renewal plan.</span> For a complete list of the terms of your membership please <a href="https://www.bookofthemonth.com/membership-terms.html" style="color:#2cc4ee; text-decoration:none; ">click here</a>. If you would like to cancel your membership at any time, <span class="appleLinksGray">please call 1-888-784-2670</span>
                  </td>
                </tr>
              </table>
            </td>
